...
void setup() {
  ...
  ast_1 = new Asteroid(150, height/2, -500, random(2,10), 5, 0.05);
  ast_2 = new Asteroid(-width/2, height * 0.8, -500, random(2,10), 5, 0.05);
  ast_3 = new Asteroid(-width * 0.1, height * 0.1, -500, random(2,10), 5, 0.05);
